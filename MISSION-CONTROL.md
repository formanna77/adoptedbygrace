...
- Lock count documented (authoritative at S51 close: **300 per-type / 281 distinct** = 94 HAMMER / 182 POLISH / 24 CONSECRATED; S51 added exactly 4 — the reformed-apologetics hub + 3 articles, each HAMMER+CONSECRATED. POLISH is authoritatively 182, not the once-logged 200. Trust a live grep over any logged figure); may rise (new lock) or fall (revoked marker) — both valid, both must be logged.
