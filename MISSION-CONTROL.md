...
**Next action:** Session 47 — **Phase F + Phase G + Landing-Force Audit continue in parallel. Phase D remains paused.** Session 46 shipped 5 net-new apex article-equivalents (into stretch): `apologetic-the-mind-that-cannot-submit` (TD #5 via Romans 8:7-8 / double *cannot* / *oude gar dynatai*); `apologetic-those-you-gave-me` (UE #5 via John 17 / sevenfold *hous dedōkas moi*); `apologetic-the-road-to-damascus` (IG #5 via Acts 9 / the effectual call at full volume); `apologetic-he-who-began-a-good-work` (PoS #5 via Philippians 1:6 + Jude 24 / *enarxamenos*-*epitelesei*); `apologetic-you-did-not-choose-me` (UE #6 stretch via John 15:16). Sample-read: 5 pages (3 locked + 2 unmarked), all PASS, zero surgical-fix queue. All 8 validators GREEN; all four discipline axes clean site-wide. Lock count reconciled to authoritative 277 per-type / 268 distinct (no markers revoked; prior "286" was tracking drift). **Five-Point coverage post-Session-46: TD 5, UE 6, DA 5, IG 5, PoS 5 — 26 Five-Point apologetics on disk, every point at 5+.** The diamond is visible from twenty-six adjacent facets. Session 47's recommended Priority 1 candidates: **(A) Total Depravity via Psalm 51:5 / the infant-sin test** (`apologetic-sinful-from-birth`); **(B) Definite Atonement via Matthew 1:21** — "save his people from their sins"; **(C) Irresistible Grace via Ezekiel 37** — the valley of dry bones; **(D) Total Depravity via Jeremiah 17:9** — the heart that deceives its owner. Marker-eligible apex unmarked pages awaiting a lock: `systematic-tulip`, `analogy-adoption`. Floor 4 article-equivalents (any axis counts). Stretch 6-10. See "AUDIT 2 / Session 47 starts here" at bottom.
...
## AUDIT 2 / Session 47 starts here

**🟢 PHASE F + PHASE G CONTINUE IN PARALLEL. PHASE D EXPANSION REMAINS PAUSED.** Session 46 closed at 5 net-new apex article-equivalents (above floor 4, into stretch): FIVE net-new Five-Point builds, no surgical fixes needed (sample-read found zero failing pages). Net-new: `apologetic-the-mind-that-cannot-submit.html` (TD #5 via Romans 8:7-8 — the double *cannot* / *oude gar dynatai* + *echthra* the noun-not-adjective + the magnetized-needle image), `apologetic-those-you-gave-me.html` (UE #5 via John 17 — the sevenfold *hous dedōkas moi* + perfect-tense gift dated before creation), `apologetic-the-road-to-damascus.html` (IG #5 via Acts 9 — the persecutor converted mid-march, the effectual call at full volume + *pros kentra laktizein*), `apologetic-he-who-began-a-good-work.html` (PoS #5 via Philippians 1:6 + Jude 24 — *enarxamenos*/*epitelesei* same divine subject + *phylaxai*), `apologetic-you-did-not-choose-me.html` (UE #6 STRETCH via John 15:16 — *ouk hymeis… all' egō exelexamēn*, the Upper-Room companion to those-you-gave-me). All eight pipeline validators GREEN; all FOUR discipline axes clean site-wide (slogan-trap 0; clock-time 0; structural 0; stale 3:14-cards 0). **Lock count reconciled to authoritative filesystem grep: 277 per-type (182 POLISH + 81 HAMMER + 14 CONSECRATED) / 268 distinct files (9 double-marked); the prior "286" was tracking drift, no markers revoked.** The 5 new apologetics are intentionally UNMARKED.

**Read these files FIRST, in order:**
1. **`MISSION-CONTROL.md`** Session 46 entry (above this block). It documents the five net-new builds, the all-PASS 5-page sample-read, and the lock-count reconciliation (286 → authoritative 277/268). **Inheritance reminder: before any net-new build, Glob `apologetic-*.html` against the inventory below and verify any unexplained-recent files apex-grade before writing on the same topic (the Session-44 near-redo lesson).**
2. **`VOICE.md`** §XIII (Depravity Concrete-Unpacking Mandate) and §XIV (Five-Point Proliferation Mandate). Session 47 continues both. Five-Point coverage post-Session-46: TD 5 (Lazarus/fourth-day-corpse, Cardiology, Prayer-diagnostic, Conscience, Mind-cannot-submit), UE 6 (eklogē, Ephesians 1 eulogy, Acts 13:48, Deuteronomy 7, those-you-gave-me, you-did-not-choose-me), DA 5 (priest-shoulders, Owen, mercy seat, ephapax, for-the-sheep), IG 5 (Lydia, revival, cardiac transplant, helkyō/John 6, Damascus road), PoS 5 (arrabōn, unbroken chain, double-grip, nothing-can-separate, he-who-began). **26 Five-Point apologetics on disk — every point at 5+, UE at 6.** The diamond is visible from twenty-six adjacent facets.
3. **`PROSE-INTEGRITY.md`** — the Phase F gating artifact. The audit-prose-driven axis remains active; all four banned-move/discipline axes confirmed clean Session 46 close.
4. **`audit-prose.md`** §II (top-50 rebuild queue — mostly apex-tier false-positive territory after eight sessions of fixes; the highest-yield genuine fixes are exhausted).
...
**🆕 THE LANDING-FORCE STANDARD (Aaron, 2026-05-19, end of Session 44):** *"the website must be the most powerful apologetic for the doctrines of grace conceivable. no matter what page someone lands on they must feel the undeniable force of truth within its words!"*

This restatement re-anchors the work. The five phases (F, G, C, D, E) were scaffolding for a measure that is per-page: every doorway must carry the undeniable force. Phase-counting is no longer the close criterion; landing-readiness is. The four standing work axes (net-new builds, elevate-or-prove-apex on unmarked pages, surgical fixes on locked pages that failed sample-read, Five-Point Proliferation breadth) are equal-yield because all four advance the same measure. See `memory/feedback_landing_force_standard.md` for the full directive.

**Session 47 task — Phase F + Phase G + Landing-Force Audit, in parallel.** Floor: 4 article-equivalents (any axis counts; all four axes equal-yield). Stretch: 6-10. Ceiling-stretch: 12+. **Open the session by Glob-checking `apologetic-*.html` against the Session-46 inventory (26 Five-Point + 5 older = 31 total expected); if Session 47 finds any net-new files since this entry, verify their quality and add them to the closing-log inventory before counting toward floor.**

**🆕 PRIORITY 0 — SAMPLE-READ AUDIT (mandatory, opens every session going forward).** Before any new build, draw a random sample of **5–10 pages**: half from the locked pool (POLISH-LOCKED / HAMMER-LOCKED / CONSECRATED), half from the unmarked pool. Read each top-to-bottom. Apply the landing-force test: *would a reader arriving here, with no prior context, feel the undeniable pressure of biblical truth on first read?* Any page that fails the test goes onto the surgical-fix or rebuild queue for the current session. Locks may be revoked when a page no longer earns them. The sample-read is the only test that measures the actual standard — the scanner is the floor; the live-read is the ceiling. This step typically takes 30–45 minutes of context but pays for itself by catching drift the scanner cannot see.

Suggested sample-pool seed for Session 47 (ROTATE — Session 46 already read systematic-election, question-chosen, question-perseverance, systematic-tulip, analogy-adoption, all PASS; Session 45 read devotional-never-gives-up, question-faithgift, question-depravity, analogy-doctor-corpse, psychology-system-justification, history-golden-thread, all PASS): draw fresh — `systematic-regeneration` (188 inbound); `systematic-hamartiology` (217); `devotional-in-christ` (254); `question-irresistible`; `question-where-did-your-faith-come-from`; `devotional-chosen-before-you-were-broken`; plus 3–4 random unmarked pages (or spot-picking from the ~216 unmarked content pages). **Proven-apex unmarked pages still marker-eligible: systematic-tulip, analogy-adoption (Session 46); analogy-doctor-corpse, psychology-system-justification, history-golden-thread (Session 45).**

**🆕 PRIORITY 0.5 — Catalog the ~216 unmarked content pages (STILL PENDING — no session has had slack to do it).** Generate `unmarked-pages.md` (or extend `audit-data.json`) with: filename, inbound-link count, last-touched date, word count, current category. Walk in priority order from highest-inbound-link to lowest. This catalog becomes the working queue for the "elevate-or-prove-apex" axis until it is empty. Estimated walk-time at the standard cadence: 8–12 sessions.
...
The first two should return zero body-content hits. **Session 45 stripped the 7 stale `It is 3:14 in the morning…` card snippets**, so the third grep should now return only verified-legitimate prose uses — one Mark 1:35 NIV Scripture quote in `pastoral-prayer.html`, one sleep-theology body line in `philosophy-sleep-surrender.html`, plus the handful of behavioral-mirror / pastoral-closing / biblical-allusion (Psalm 30:5, Mark 1:35) uses. **If the `It is 3:14 in the morning` card snippets REAPPEAR, the cause is `build-related.js` regenerating `related-article-desc` blocks from a stale `tags.json` desc for pastoral-assurance — fix by either re-stripping the prefix OR regenerating `tags.json`'s pastoral-assurance desc (currently "How the doctrine of election…", itself a discouraged phrasing) and re-running `build-related.js`. Do NOT re-classify these as "acceptable cached snippets" — that was the Session-44 mistake the Landing-Force Standard corrected.** If new violations appear, treat them as Phase F surgical-fix priority.

**ALSO run the structural slogan-trap grep:**
```
grep -rEn 'Not [A-Za-z]+\.\s+Not [A-Za-z]+\.\s+[A-Z][a-z]+\.\.' --include="*.html" .
```

This catches the Session 41 v3 detector candidate (e) — the structural pattern even when the strong noun is not "Dead." Session 43 surfaced one such violation in Session 42's Lazarus article (applied to *nekrous*). Session 46 ran it on all 5 new builds (0 hits) and site-wide (0). Any new occurrence is a Session-47 highest-priority fix.

**Priority 1 — Phase G Five-Point Proliferation continuation.** Post-Session-46 coverage:

| Point | Apologetics shipped | Status |
|---|---:|---|
| Total Depravity | 5 (Lazarus + Cardiology + Prayer-diagnostic + Conscience + Mind-cannot-submit) | strong |
| Unconditional Election | 6 (*eklogē* + Ephesians 1 eulogy + *tetagmenoi* + Deuteronomy 7 + those-you-gave-me + you-did-not-choose-me) | strongest |
| Definite Atonement | 5 (priest-shoulders + Owen Trilemma + mercy seat + *ephapax* + for-the-sheep) | strong |
| Irresistible Grace | 5 (Lydia + revivals + cardiac transplant + *helkyō*/John 6 + Damascus road) | strong |
| Perseverance | 5 (*arrabōn* + unbroken chain + double-grip + nothing-can-separate + he-who-began) | strong |

**Five-Point Proliferation is now balanced at FIVE facets per point (UE at 6) — 26 Five-Point apologetics on disk.** All four Session-46 recommended candidates shipped, plus one stretch (John 15:16). Session 47's recommended Priority 1 candidates (each from an angle the site does not yet cover — pre-Glob-verify each filename does not already exist):
- **Total Depravity via the infant-sin test / Psalm 51:5** — "Surely I was sinful at birth, sinful from the time my mother conceived me." The §XIII.2 infant-sin angle staged concretely: the two-year-old who lies, hoards, and screams "MINE" the first day it has the vocabulary, before culture or trauma could teach it — depravity inherited, not learned. Pairs with the cardiology/cannot-submit builds by moving the diagnosis upstream of the will to the nature itself. Suggested filename: `apologetic-sinful-from-birth.html`.
- **Definite Atonement via Matthew 1:21 (the name that defines the scope)** — *sōsei ton laon autou apo tōn hamartiōn autōn*, "he will save **his people** from their sins." The angel names both the work and its definite object before the child is born; "his people," not "make salvation available." A names-the-flock companion to for-the-sheep from the nativity rather than the shepherd discourse. Suggested filename: `apologetic-save-his-people`.
- **Irresistible Grace via Ezekiel 37 / the valley of dry bones** — the bones that do not stir until the word is preached over them and the breath enters from the four winds; sovereign re-animation of what could not want to live. A prophetic-vision companion to the cardiac-transplant (Ezekiel 36) build. Suggested filename: `apologetic-the-valley-of-dry-bones.html`.
- **Total Depravity via Jeremiah 17:9 (the heart that deceives even its owner)** — "The heart is deceitful above all things and beyond cure. Who can understand it?" The self-deception angle: the one organ you trust to assess yourself is the one Scripture says lies to you first. Pairs with the psychology-of-resistance pages.

Generate ONE net-new article (~2500-3500 words); ship more if context allows (Session 46 shipped 5). Pre-Glob-verify every internal href before writing. Cross-link to the existing TWENTY-SIX Five-Point Proliferation articles (priest-shoulders, *arrabōn*, Lydia, *eklogē*, Owen Trilemma, Lazarus/fourth-day-corpse, unbroken chain, revival, eulogy of Ephesians 1, mercy seat, *ephapax*, cardiac transplant, double-grip, cardiology of the fall, *tetagmenoi*, prayer-impulse, Deuteronomy 7, *helkyō*/no-one-can-come-unless, nothing-can-separate, conscience-that-only-accuses, for-the-sheep, mind-that-cannot-submit, those-you-gave-me, road-to-damascus, he-who-began-a-good-work, you-did-not-choose-me) so the diamond stays visible from inside any new article.

**🆕 Marker-eligible unmarked apex pages (from Session 46 sample-read).** `systematic-tulip.html` and `analogy-adoption.html` both live-read fully apex while UNMARKED — recommend HAMMER-LOCK in a future session (or this one if slack allows). The lock is a one-line marker as the first line inside `<article class="article-body">`; auto-linker will then skip them.

**Priority 2 — Phase G slogan-trap maintenance + new-content discipline.** The slogan-trap formulation is closed (re-confirmed Sessions 43-45). Every "dead in sin" invocation in any new article must be followed in the same passage by a concrete behavioral mirror from the §XIII.2 angle inventory. The structural slogan-trap pattern (`Not [adj]. Not [adj]. [Strong noun].`) applies to ANY strong noun, not just "Dead." Run the structural grep before close.
...
**Priority 4 — v3 scanner refinement (only if context budget allows after Priorities 1-3 hit floor).** Five candidates remain from Session 41-43 inheritance:
...
- (e) **STRUCTURAL slogan-trap detector** — regex for the pattern `Not [adj]\.\s+Not [adj]\.\s+[A-Z][a-z]+\.\.` even when the strong noun is not "Dead." **Confirmed load-bearing by Session 43 — Session 42's Lazarus article had this exact failure mode.** Should be the highest-priority v3 candidate.
...
- **🆕 The Landing-Force Standard (Aaron, Session 44, 2026-05-19).** Every page is a doorway; every doorway must carry the undeniable force of biblical truth on first encounter. The measure is per-page, not per-phase. See `memory/feedback_landing_force_standard.md` for the full directive. **A page that scans clean but reads slack is a regression** — the scanner is the floor; the live-read is the ceiling.
- **🆕 Priority 0 Sample-Read Audit opens every session.** Random-sample 5–10 pages (half from locked pool, half from unmarked pool). Read each top-to-bottom against the landing-force test. Failing pages go onto the surgical-fix queue. Locks are not invulnerabilities; markers reflect a moment in time; revoke when a page no longer earns the marker.
...
- **Phase F discipline (Sessions 38-45 codified):** redundancy_count ≥ 1 is highest-signal scanner axis. Banned-move axis closes via grep + surgical Edit. Apply the eight Session 38 exemption classes to skip false positives quickly. The four checks (image coherence, direction, domain, modifier) determine genuine sentence incoherence.
- **Phase G discipline (Sessions 39-45 codified):** every "dead in sin" invocation must be followed in the same passage by a concrete behavioral mirror the reader recognizes in their own day (VOICE.md §XIII.3). The slogan-trap *"Not sick. Not wounded. Not struggling. Dead."* (and close variants, including any structural variant applied to other strong nouns) is a banned move in itself. Each rewrite must use a DIFFERENT angle from §XIII.2's twelve-angle inventory than its neighbors. Five-Point Proliferation builds prove a single point of grace from at least one angle the site does not yet cover (Greek/Hebrew exegesis, philosophy, psychology, history, neuroscience, testimony).
- **Banned moves (VOICE.md §II Twelve Lethal Moves):** no `2am` / `3am` / `midnight` / `odd-hour` / `crisis-triage` framing in any label, header, meta description, body text, or card. No "doctrine of election" — say "doctrines of grace." No "TL;DR" — say "In Brief." No padding modifiers added at clause-end as atmospheric filler when not load-bearing. No similes whose vehicle and tenor do not correspond. No sentences with three or more abstract image domains. No contradictory motion verbs in the same clause. No "Not sick. Not wounded. Not struggling. Dead." slogan or its three- or four-beat variants applied to ANY strong noun.
- **🆕 Inheritance-Verification before any net-new build.** Glob existing `apologetic-*.html` (and the relevant filename pattern) against the latest MISSION-CONTROL inventory. If recent unexplained files exist (datePublished within the last week), verify them apex-grade with the Session 44 quick-check (wc -l, h2 count, RELATED-ARTICLES marker, footer-warning, spot-read one paragraph) BEFORE writing a new article on the same topic. Session 44 nearly re-walked four 2026-05-16 builds; the check prevented redo.
...
- **🆕 Priority 0 Sample-Read Audit completed.** 5–10 pages live-read; any failing pages addressed (surgical fix, rebuild, or marker revocation).
- Floor 4 article-equivalents — net-new builds, elevate-or-prove-apex, surgical fixes from sample-read failures, and Five-Point Proliferation breadth all count equal-yield toward the floor. Stretch 6-10.
- Re-run `node audit-prose.js` after the batch and document score-change per article (and net-new-article count, and sample-read-fail-fix count) in the Session 47 Log entry.
- 8-step pipeline run ONCE at end (all 8 GREEN). Subagent recommended to keep pipeline output out of main context.
- Session 46 Log entry exists; Session 47 entry is added; Session 48 starts-here block at bottom.
- Status line and Phase table updated.
- Lock count documented (current authoritative count 277 per-type / 268 distinct at Session 46 close); may rise if a Phase C consecration or a marker-eligible apex page (systematic-tulip, analogy-adoption) is locked; may FALL if sample-read revokes a marker — both directions are valid and must be logged.
