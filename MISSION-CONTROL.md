...
**Session 50 task — Phase F + Phase G + Landing-Force Audit, in parallel.** Floor: 4 article-equivalents (any axis counts). Stretch: 6-10. Ceiling-stretch: 12+. **Open by Glob-checking `apologetic-*.html` against the post-Session-49 inventory (37 Five-Point + 5 older = 42 total expected); verify any net-new files apex-grade before counting toward floor.**

**🆕 PRIORITY 0 — SAMPLE-READ AUDIT (mandatory, opens every session).** Draw a fresh random sample of 5–10 pages — half locked, half unmarked — and live-read each top-to-bottom against the landing-force test. Any page that fails goes onto the surgical-fix/rebuild queue; locks may be revoked. **ROTATE — already read and PASSED: S49 read question-irresistible, devotional-chosen-before-you-were-broken, two-arms (HAMMER-LOCKED), start-here-phase1, apologetic-the-valley-of-dry-bones, systematic-imputation, analogy-drowning-man (all 7 PASS; one watch-note — devotional-chosen-before-you-were-broken brushes but does not cross the odd-hour register with dense "tonight/this hour" repetition); S48 read systematic-hamartiology + pastoral-assurance (both PASS; confirmed the old 3:14-in-the-morning banned-move in pastoral-assurance is gone); S47 read systematic-regeneration, question-where-did-your-faith-come-from, devotional-in-christ, systematic-reprobation, word-study-every-all, analogy-chess-grandmaster; S46 read systematic-election, question-chosen, question-perseverance, systematic-tulip, analogy-adoption; S45 read devotional-never-gives-up, question-faithgift, question-depravity, analogy-doctor-corpse, psychology-system-justification, history-golden-thread.** Suggested fresh seed for S50: `systematic-atonement`, `question-chosen` (re-read), `devotional-in-christ`, `the-mirror`, one of the six new S49 apologetics read end-to-end (e.g. `apologetic-the-washing-of-rebirth` or `apologetic-only-evil-all-the-time`), plus 2–3 random unmarked content pages. The live-read is the ceiling; the scanner is the floor.
...
- Lock count documented (authoritative at S49 close: 298 per-type / 289 distinct, UNCHANGED — the 182→200 POLISH drift is now RESOLVED, live grep authoritatively 200); may rise (new lock) or fall (revoked marker) — both valid, both must be logged.
