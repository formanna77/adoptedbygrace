...
| **FiveSolas.com (Reformed Links Page)** | Resource-page inclusion — verified live S112 (/reflink.htm lists Monergism, APM, The Highway: our exact shelf). **Contact path NOT yet verified — one browser step before sending** (mailto links invisible to the fetcher) | `docs/outreach/resource-page-pitches.md` Target 6 | — | — | — |
