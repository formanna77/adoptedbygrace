# Pitch #3 Batch — Resource-Page Inclusion Requests (3 verified targets)

**Prepared 2026-06-10 (S108).** All three targets verified live and fitting today — pages fetched and read before drafting. One was investigated and **rejected**: GraceNet UK (grace.org.uk) maintains a Reformed links directory but its homepage is currently compromised with injected spam links — do not associate with it.

Send from Aaron's email. Log each send in `docs/outreach-log.md`. One follow-up after ~2 weeks, never more.
...
## Target 2 — ReasonableTheology.org (Clayton Kraby)

**Page:** https://reasonabletheology.org/five-points-calvinism-defining-doctrines-of-grace/ — his flagship five-points explainer ends with a "Recommended Resources" section (Piper, Sproul, Phillips); the site also runs a "Helpful Resources" category. Active site (comments answered through 2026). Contact: https://reasonabletheology.org/contact/ (form, or the email given there).

**Subject:** A possible addition to your Five Points recommended resources

Hi Clayton,

Your "Five Points of Calvinism" explainer does in eight minutes what most treatments need a book for — sound doctrine in plain language, exactly as advertised. Thank you for it.

If you ever expand the Recommended Resources at the end, here's one for consideration: a free five-phase reading journey through the doctrines of grace at https://adoptedbygrace.net/start-here — foundations, the five points, the key passages walked through in the reader's own Bible, the hard objections faced, and what changes when it lands. It's built for exactly the reader who finishes your article wanting to go deeper. Free, ad-free, no paywall, no mailing-list gate.

Either way, grateful for what you're doing.
...
## Target 3 — Challies.com (Tim Challies — A La Carte)

**Page:** https://www.challies.com/collections/a-la-carte/ — the daily curated link roundup that has informed the Reforming since 2003; the single most-read curation channel in the Reformed world. He links individual articles, not sites. Contact: https://www.challies.com/contact/ (he notes the form is flaky — use the email address listed on that page).

**Subject:** An article for A La Carte consideration

Hi Tim,

One article for your consideration, offered with no expectation: "Where Did Your Faith Come From?" — https://adoptedbygrace.net/question-where-did-your-faith-come-from

It walks a reader, step by step, from premises every Christian already holds to the conclusion that crediting ourselves for our own faith is a quiet form of works-righteousness — and that grace runs deeper than most of us dare to believe. Readers tell us it's the page that finally made election feel like good news. Free site, no paywall, no ads.

Thank you for two decades of informing the reforming — A La Carte has been a daily mercy to more of us than you know.
