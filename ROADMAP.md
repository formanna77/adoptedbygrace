...
- `broken-mirror-grace-too-good.html` — ✅ "When Grace Feels Too Good to Be True: The Shame of Being Chosen" — Broken Mirror healing article (now 6 articles). New wound species: transactional shame — the inability to receive an unconditional gift due to lifetime of conditional love. Diagnostic inversion: suspicion of grace IS evidence grace is at work. "The suspicion of grace is itself the wound that grace came to heal." Sovereignty as the only cure: if salvation rests on God's choice, not yours, the evaluation is over. Vessel truth (Rom 9:23). "The shoe already dropped — on Calvary." Prayer for the suspicious heart. Fills Tier 2 Broken Mirror backlog.
- `story-historical-luther-storm.html` — ✅ "The Night the Storm Made a Monk" — Historical fiction (now 3 historical fiction stories). July 2, 1505, Stotternheim. Full sensory narrative: the darkening sky, the copper-colored evening light, the mud, the scream. Luther's decade of monastic despair. The tower experience with Romans 1:17. The chain of sovereignty: lightning → monastery → despair → Romans 1:17 → 95 Theses → Reformation. "God threw lightning at a road in Thuringia and knocked a law student into the mud and rearranged the next five centuries." Fills Tier 2 stories backlog (Luther thunderstorm).

### Recent Builds (2026-03-31 Creator Session #7 — Redefining Grace + Imposter Syndrome + Drowning Man)
- `resistance-redefining-grace.html` — ✅ "The Art of Redefining Grace: How We Turn a Gift Into an Achievement" — Resistance page (category had only 1 page, now 2). Gift-refusal paradox opening: insisting on paying for a gift insults the giver. Socratic trap: walks reader through Eph 2:8-9 → Phil 1:29 → "where did your faith come from?" → fork with no escape. Names the resistance (unconscious redefinition of grace to include self). Shows compassion for the ego's need for agency. Dismantles with Chesterton-style wit. Crown Jewel woven throughout. 5+ internal links. Force multipliers: gift-refusal analogy, devastating question, humor bomb, pull quotes, pastoral whisper.
- `broken-mirror-imposter-syndrome.html` — ✅ "The Christian Who Feels Like a Fraud: When Grace Meets Imposter Syndrome" — Broken Mirror healing article (now 5 articles). Diagnostic inversion technique: doubt about faith authenticity is EVIDENCE of genuine conversion. Opens with sitting in church feeling nothing while everyone worships. Names the shame: imposter syndrome in the pew. Crown Jewel applied pastorally: if salvation depends on your faith quality, imposter syndrome is inevitable. Sovereignty DISSOLVES imposter syndrome. Romans 9:23 identity reconstruction. Phil 1:6, 2 Tim 1:12 as Scripture knockouts. Buechner tenderness + Keller bridge-building.
- `analogy-drowning-man.html` — ✅ "The Drowning Man Who Thinks He's Swimming" — Analogy page (now 6 pages). THE most accessible entry point to the doctrines of grace. Drowning vs. dead distinction: every gospel presentation that says "you were drowning" has already conceded the Arminian position. Eph 2:1 says DEAD. Dead men don't grab ropes. Ezekiel 37 (bones don't choose to live), John 11 (Lazarus didn't choose to rise), John 6:44. Humor bomb: a corpse taking credit for CPR. Lewis clarity + Chesterton paradox. The "front door" analogy for the entire site.

### Recent Builds (2026-03-31 Creator Session #6 — Marriage Wall + Pastor Lens + Senseless Death)
- `invisible-wall-marriage.html` — ✅ "When You and Your Spouse Speak Different Languages: The Invisible Wall in Marriage" — Invisible Wall healing article for the Reformed believer whose spouse doesn't share their convictions. Prayer divergence opening: lying in bed, praying to different understandings of the same God. Names conjugal guilt (the sense of having broken spiritual unity). Three-world comparison. Five graces for marriage (restraint, remembering, gratitude, modeling, entrusting). Double pastoral whisper technique. Scripture: 1 Cor 4:7, 1 Pet 3:1-2. Crown Jewel connection: the spouse who says "I chose God" is claiming credit for a gift. Targets Tier 1 healing backlog (Invisible Wall — now 5 articles).
- `shattered-lens-pastor.html` — ✅ "When Your Pastor Teaches What You Know Isn't True: The Shattered Lens in the Pew" — Shattered Lens healing article. Sunday morning stomach-drop opening. Names ecclesial guilt (disagreeing with shepherd = rebelling against God). Acts 17:11 Bereans reframe: testing teaching is the biblical standard, not rebellion. Four paths forward framework (stay quietly, speak privately, grieve and leave, wait). Scripture: Acts 17:11, 1 John 4:1, 1 Thess 5:21, Eph 2:8-9. Crown Jewel connection: Arminian teaching isn't just theology — it's a claim about grace itself. Targets Tier 1 healing backlog (Shattered Lens — now 4 articles).
- `open-wound-senseless-death.html` — ✅ "When the Death Makes No Sense: Sovereignty and the Loss That Has No Explanation" — Open Wound healing article. Softest page on the site. Kitchen-table-after opening: casseroles, condolence texts, cold coffee. Names absent meaning (grief for the WHY that never comes). Exposes three clichés ("everything happens for a reason," "God needed an angel," "at least they're not suffering"). Job's answer: presence, not explanation. Psalm 88: permission for unresolved grief. Page deliberately withholds resolution — mirrors Job's structure. Scripture: Job 38-42, Ps 88, Ps 139:16, John 11:35, Rom 8:28, Rev 21:4. Targets Tier 1 healing backlog (Open Wound — now 5 articles).

### Recent Builds (2026-03-31 Creator Session #5 — Manipulation + Family Wall + Terminal Diagnosis)
- `objection-manipulation.html` — ✅ "Is God Manipulating Us? The Difference Between a Puppet Master and a Father" — FINAL objection page, completing the full objection library. Definitional dismantling technique: defines manipulation (deception + self-interest + diminishment), tests sovereignty against each criterion, shows sovereignty satisfies the OPPOSITE of each. Greek word study: energeō (Phil 2:13) — God powers from WITHIN, not from outside. Author/puppet-master analogy via archēgos (Heb 12:2). 5 arguments, 7 objections answered, 4 historical witnesses (Augustine, Edwards, Spurgeon, Calvin). Crown Jewel connection: manipulation charge protects self-credit for salvation. Targets Tier 1 objection backlog — **LIBRARY NOW COMPLETE**.
- `invisible-wall-family.html` — ✅ "When Your Family Can't Follow You Here: The Invisible Wall at the Dinner Table" — Invisible Wall healing article. Arresting image opening: the photograph on the mantle that tells a lie. Names filial guilt (the unique guilt of seeing something your parents can't see). Three-world comparison. Five graces for the dinner table (restraint, remembering, gratitude, questions over answers, entrusting). Scripture: 1 Cor 4:7, John 6:44, Phil 1:6, 1 Cor 3:6-7. Sovereignty as the specific comfort: you are not responsible for the gap. Targets Tier 1 healing backlog (Invisible Wall — now 4 articles).
- `open-wound-terminal-diagnosis.html` — ✅ "When the Diagnosis Is Terminal: Sovereignty and the End You Didn't Choose" — Open Wound healing article for the terminally ill and those who love them. Concrete sensory opening: the doctor's mouth is still moving but the sound has stopped. Three-world comparison (meaningless biology / faith-blame / impotent God). Sovereignty as the only theology that survives the deathbed. Psalm 139:16 kullam analysis. Section for caregivers/loved ones. Scripture: Ps 139:16, Job 14:5, Rom 8:38-39, 2 Cor 4:16-18, Ps 23:4, Rev 21:4. Targets Tier 1 healing backlog (Open Wound — now 4 articles).

### Recent Builds (2026-03-31 Creator Session #4 — Singing Alone + Empty Nursery + Babies Objection)
- `invisible-wall-singing-alone.html` — ✅ "When You See It and Your Church Doesn't: The Loneliness of Singing Alone" — Invisible Wall healing article. Opens with the split-hymn image (singing Amazing Grace beside someone who means something different by it). Names unilateral theological isolation in a mixed church. Three-world comparison. 5 practical sustaining graces. Scripture: 1 Cor 4:7, Acts 17:26-27, Heb 12:1. Names the temptation of superiority. Targets Tier 1 healing backlog (Invisible Wall — now 3 articles).
- `open-wound-empty-nursery.html` — ✅ "When God Is Sovereign and the Nursery Is Empty" — Open Wound healing article on sovereignty and miscarriage. Opens with "absent future" image: the room that was supposed to be full. Three-world comparison. Sovereignty as comfort not cruelty. Self-blame as self-sovereignty. Lament as worship (Psalm 88). WCF 10.3 on infant salvation. Scripture: Ps 139:13-16, Job 1:21, Ps 56:8, Ps 88. Targets Tier 1 healing backlog (Open Wound — now 3 articles).
- `objection-babies.html` — ✅ "What About Babies Who Die? Election, Infant Salvation, and the God Who Saves Without Permission" — Boomerang objection page: the babies objection PROVES election. Three options fork (innocence/accountability/sovereign grace). Only Option C works. 5 objections answered. Spurgeon, Warfield, WCF quotes. Crown Jewel connection: every parent who says "my baby is with Jesus" has confessed sovereign grace. Targets Tier 1 objection backlog (babies — now only manipulation remains for complete library).
...
- `psychology-terror-management.html` — **NEW** "Terror Management and the Threat of Sovereignty: Why God's Control Feels Like Death" — Ernest Becker's TMT (1973), 500+ experiments (Solomon, Greenberg, Pyszczynski), mortality salience, self-esteem as anxiety buffer, "immortality projects," close-relationship partners under threat. Five mechanisms mapped to Romans 9:16, Hebrews 2:14-15, Ephesians 2:8-9, 2 Timothy 1:9-10, Romans 8:38-39. Supreme irony: the loss of control that triggers terror is the only cure. Literary device: scientific hypothesis-test. ✅ (2026-03-30 Creator)
- `objection-why-believe.html` — **NEW** "If God Already Chose Us, Why Do We Have to Believe?" — Letter format ("Dear friend..."). God ordains means AND ends (2 Thess 2:13), dead men raised then walk (Eph 2:1-5), faith is gifted (Phil 1:29, echaristhē), wedding invitation parable (Matt 22), commands carry creating power (Lazarus). Greek word studies, four theologians (Spurgeon, Edwards, Augustine, Calvin). ✅ (2026-03-30 Creator)
- `debate-free-will.html` — **NEW** "The Great Debate: Does Man Have Free Will?" — FIRST formal debate page on the site. Libertarian free will vs. biblical sovereignty. Opening statements, rebuttals, cross-examination (6 devastating questions per side), closing arguments, verdict. Both sides steel-manned with quotes from Arminius/Wesley AND Augustine/Calvin/Spurgeon/Edwards. The Romans 9:19 test as decisive. Literary device: formal debate. ✅ (2026-03-30 Creator)
