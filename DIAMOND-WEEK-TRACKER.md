...
Apr 6 | Enhancer | philosophy-exclusive-love.html | CONTENT | Inserted new Section 07 "But What About 'God So Loved the World'?" between original Section 6 and "What Comes After" — pre-empts the #1 Arminian counter-verse with NIV blockquote of John 3:16, Greek `kosmos` exegesis, "Parent Who Loves All His Children" Brilliant Connection, critical-distinction box, devastating biblical fork (Pharaoh/Esau/Judas), pull-quote, John 6:37 + 10:27-28 cross-reference, pastoral whisper closing (~900 words). 5 verified cross-category links. Lane-clean.

Apr 6 | Enhancer | philosophy-problem-of-merit.html | CONTENT | Inserted new Section 06 "The Lottery Ticket You Didn't Buy" before original Section 06 (renumbered to 07) — Parable of Something They Trust (lottery ticket + theatrical "thank myself" speech), Steelmanned Objection subsection (necessary ≠ meritorious), willingness-regress argument, pull-quote, Two-Answer Fork, humor bomb, pastoral whisper (~1100 words). 8 verified cross-category links. Lane-clean.

Apr 6 | Enhancer | analogy-song-you-didnt-compose.html | CONTENT | Inserted new section "The Lullaby Sung Over the Womb" between "The Crown Jewel Question" and "You Were Composed Before the First Note" — pregnant-mother-singing-through-the-womb Brilliant Connection ("who chose whom?"), Jeremiah 1:5 blockquote, "The Pre-emption" subsection (steelmans the response objection), Two-Answer Fork with absurdity reveal, "The Humor at the Bottom of the Crib" (Arminian newborn acceptance speech), pastoral whisper closing (~1100 words). 8 verified cross-category links. Lane-clean.
