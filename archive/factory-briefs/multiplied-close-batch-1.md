...
<div class="cl-cat">ANALOGY</div>
   ...
   <div class="cl-cat">ANALOGY</div>
   <div class="cl-title">The Chess Grandmaster</div>

    <a href="/analogy-drowning-man" class="cross-link">
   <div class="cl-cat">ANALOGY</div>
   <div class="cl-title">The Drowning Man and the Rescue</div>
</a>
    
   <div class="cl-cat">OBJECTION</div>
   <div class="cl-title">Does This Make Us Robots?</div>

    <a href="/psychology-autonomy-illusion" class="cross-link">
   <div class="cl-cat">PSYCHOLOGY</div>
   <div class="cl-title">The Autonomy Illusion</div>
</a>
    <a href="/question-where-did-your-faith-come-from" class="cross-link">
   <div class="cl-cat">QUESTIONS</div>
   <div class="cl-title">Where Did Your Faith Come From?</div>
</a>
    <a href="/secular-billion-decisions" class="cross-link">
   <div class="cl-cat">SECULAR</div>
   <div class="cl-title">The Billion Decisions</div>
</a>
    <a href="/devotional-not-my-will-but-joy" class="cross-link">
   <div class="cl-cat">DEVOTIONAL</div>
   <div class="cl-title">Not My Will, But Joy</div>
</a>
</div>
</section>

<section class="never-gives-up-banner">
    <div>
   <h3>You Are Held</h3>
   <p>If you're running from God, know this: He will not let you go. Your rebellion cannot exhaust His patience. Your doubt cannot diminish His grip. You are held by grace that never surrenders.</p>
...
<span class="scripture-ref">— Romans 9:16</span>
    ...
    <div class="verdict">
   <div class="verdict-label">The Core Issue</div>
   <p><em>If God did 99% and you did 1%, who determined the outcome — the 99% or the 1%? In every transaction in the universe, the deciding factor is the one that tips the scale. Your 1% is the hero of the story. Is that grace?</em></p>
   <p>
  Monergism and synergism cannot both be true. Either God alone is the efficient cause of
   regeneration, or human cooperation is necessary. Scripture is unambiguous: the new birth is
  "not of natural descent, nor of human decision or a husband's will, but born of God" (John 1:13). God "made us alive" when we were "dead" (Eph 2:5).
</p>
   <p>
  Every biblical metaphor for conversion — creation, resurrection, new birth, heart transplant —
  depicts a unilateral divine act upon an incapable recipient. Not one metaphor depicts a
  ...
  rests on an immovable foundation: the sovereign, unchangeable, almighty will of God.
   ...
   <div class="cross-link-label">Comparison</div>
   <div class="cross-link-title">Calvinism vs. Arminianism</div>
   <div class="cross-link-desc">All five points of <a href="/systematic-tulip">TULIP</a> compared and examined</div>
   
   <div class="cross-link-label">Deep Dive</div>
   <div class="cross-link-title">Total Depravity</div>
   <div class="cross-link-desc">How fallen is humanity? The biblical evidence</div>
   
   <div class="cross-link-label">Deep Dive</div>
   <div class="cross-link-title">Irresistible Grace</div>
   <div class="cross-link-desc">Can the elect resist the Spirit's effectual call?</div>
...
### Scripture this page already cites, resolved to NIV 2011 ground truth
- **John 3:3-8** — "Very truly I tell you, no one can see the kingdom of God unless they are born again. How can someone be born when they are old? Nicodemus asked. Surely they cannot enter a second time into their mother's womb to be born! Very truly I tell you, no one can enter the kingdom of God unless they are born of water and the Spirit. Flesh gives birth to flesh, but the Spirit gives birth to spirit. You should not be surprised at my saying, 'You must be born again.' The wind blows wherever it pleases. You hear its sound, but you cannot tell where it comes from or where it is going. So it is with everyone born of the Spirit."
...
<p><em>Father, let me believe this today: before I was, I was chosen. Before I could do anything, You determined to make me Yours. Help me rest in that choice. Let the glory of Your decision — made in eternity, paid for in blood — become the ground of my peace. In Jesus' name, amen.</em></p>
   ...
   <div class="card-number">01</div>
   <h3 class="card-title">Are You Really Chosen?</h3>
   <p class="card-description">What election actually means — and why it is the most comforting truth in the Bible.</p>
   <div class="card-footer">
   <span class="card-read">Read <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg></span>
</div>
</a>
   <a href="/devotional-love-letter-before-time" class="hub-card">
   <div class="card-number">02</div>
   <h3 class="card-title">A Love Letter Before Time</h3>
   <p class="card-description">God's love for you didn't begin the day you believed. It began before the world existed.</p>
   <div class="card-footer">
   <span class="card-read">Read <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg></span>
</div>
</a>
   ...
   <h3 class="card-title">Is Faith a Gift or a Choice?</h3>
   <p class="card-description">The question at the heart of everything — and the answer that changes everything.</p>
   <div class="card-footer">
   <span class="card-read">Read <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg></span>
</div>
</a>
