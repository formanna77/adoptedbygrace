            ...
            subcategories: [
                {
                    ...
                    count: 75,
                    pages: [
                        { name: '"Not Because of Our Works" — The Verse That Ends the Debate', href: '/question-2tim1-9', desc: '2 Timothy 1:9 is seven words of dynamite:' },
                        ...
                        { name: 'Does "Foreknowledge" Mean God Saw You\'d Believe? Not Even Close.', href: '/question-foreknowledge', desc: 'Romans 8:29 — the Arminian trump card.' },
                        ...
                        { name: 'Does God Predestine People to Hell? The Honest Answer', href: '/question-predestined-to-hell', desc: 'The question everyone asks but few answer honestly. Scripture draws a clear distinction between election and reprobation' },
                        ...
                        { name: 'Doesn\'t God Want Everyone Saved? — The Two Wills of God', href: '/question-godwants', desc: '1 Timothy 2:4 says God wants all people saved. But if He' },
                        ...
                        { name: 'Every Conversion in Acts — God Did It Every Single Time', href: '/question-every-conversion-acts', desc: 'Walk through every single conversion in Acts and see the pattern: in EVERY case, God initiates. The Spirit moves, the eu' },
                        ...
                        { name: 'Is Free Will Real? What the Bible Actually Teaches About Human Choice', href: '/question-freewill', desc: 'You feel free. But Scripture says you' },
                        { name: 'Is God Unfair? Paul\'s Answer Will Silence You — Romans 9:19-23', href: '/question-unfair', desc: 'You want to accuse God of injustice. Paul already anticipated your objection — and his answer isn' },
                        ...
                        { name: 'The Autonomy Audit — Is Your View of Free Will Internally Consistent?', href: '/question-autonomy-audit', desc: 'Ten scenarios that test whether your view of human free will is actually compatible with God' },
                        ...
                        { name: 'The Call You Can Ignore vs. The Call That Creates Life', href: '/question-external-internal-call', desc: 'Scripture teaches that God calls all people outwardly — but only the elect receive the internal call that creates faith ' },
                        ...
                        { name: 'The Great Debate — Does Man Have Free Will? Two Sides. Scripture Decides.', href: '/debate-free-will', desc: 'A rigorous formal debate: the strongest case for libertarian free will vs. biblical sovereignty. Both sides argue their ' },
                        { name: 'The Greek Tense That Settles the Debate — 1 John 5:1', href: '/question-1john5-1', desc: 'One Greek verb tense in 1 John 5:1 proves regeneration comes before faith. The perfect tense' },
                        ...
                        { name: 'What About "Whosoever Will"? — The Verse That Doesn\'t Say What You Think', href: '/question-whosoever', desc: 'What About "Whosoever Will"? — The Verse That Doesn\'t Say What You Think' },
                        ...
                        { name: 'Where Does Your "No" Come From? The Self-Referential Trap', href: '/question-where-does-your-no-come-from', desc: 'If you reject sovereign grace, where does that rejection originate? From your' },
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'Calvinism vs Arminianism — What Does the Bible Actually Teach?', href: '/compare-calvinism-arminianism', desc: 'The definitive biblical comparison. Point by point, verse by verse — what Scripture actually teaches about salvation, an' },
                        ...
                        { name: 'Predestination vs Foreknowledge — Which Comes First?', href: '/compare-predestination-foreknowledge', desc: 'Does God predestine based on what He foresees, or does He foreknow because He predestined? The answer determines whether' },
                        { name: 'Reformed vs Catholic — How Are We Actually Justified Before God?', href: '/compare-calvinism-catholic-soteriology', desc: 'Imputed or infused? Faith alone or faith plus works? The fundamental disagreement between Reformed and Catholic soteriol' },
            ...
            subcategories: [
                {
                    ...
                    pages: [
                        ...
                        { name: 'Justified — How God Declares Guilty Sinners Righteous', href: '/systematic-justification', desc: 'You stand before a holy God guilty of everything. And He declares you righteous — not because of anything you' },
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'Moses, Pharaoh, and the God Who Hardened a King\'s Heart', href: '/ot-moses-pharaoh', desc: 'God showed mercy to Moses and hardened Pharaoh' },
                        { name: 'Noah: Chosen for Preservation', href: '/ot-noah', desc: 'Noah: Chosen for Preservation — Explore how God' },
                        { name: 'The Bible\'s First Election — Abel, Cain, and the God Who Chose', href: '/ot-abel-cain', desc: 'Genesis 4 reveals God' },
            ...
            subcategories: [
                {
                    ...
                    count: 30,
                    pages: [
                        { name: '"Choose This Day Whom You Will Serve" — Does Joshua 24:15 Prove Free Will?', href: '/demolition-joshua24-15', desc: 'The most quoted Arminian proof text. But Joshua isn' },
                        ...
                        { name: '"Faith Is Not a Gift" — Why the Most Popular Objection to Grace Collapses', href: '/demolition-faith-is-not-a-gift', desc: 'They say the grammar of Ephesians 2:8 doesn' },
                        ...
                        { name: '"In Christ All Shall Be Made Alive" — But Who Are the "All"?', href: '/demolition-1cor15-22', desc: 'They quote 1 Corinthians 15:22 to prove universal atonement. But read it again: the' },
                        ...
                        { name: '"You Always Resist the Holy Spirit" — Does Acts 7:51 Disprove Irresistible Grace?', href: '/demolition-acts7-51', desc: 'Stephen accused Israel of resisting the Holy Spirit. Case closed against irresistible grace? Not even close. There' },
                        ...
                        { name: 'Children of Satan — What Scripture Actually Calls the Unregenerate', href: '/demolition-children-of-satan', desc: 'Every passage where the Bible identifies unregenerate humans as children of the devil, slaves to sin, captives in darkne' },
                        { name: 'Cut Off from the Root — Why Sin Doesn\'t Just Wound. It Kills.', href: '/demolition-cut-off-from-root', desc: 'When a creature rebels against its Creator, the consequences are total and irreversible. The relationship is destroyed —' },
                        ...
                        { name: 'Does God Take Pleasure in Death? What Ezekiel 18:23 Actually Means', href: '/demolition-ezekiel18-23', desc: 'Does God Take Pleasure in Death? What Ezekiel 18:23 Actually Means' },
                        { name: 'Does God Want Everyone Saved? What 1 Timothy 2:4 Actually Says', href: '/demolition-1tim2-4', desc: 'They say God wants every individual saved. But Paul wrote this verse to Timothy about praying for kings and authorities ' },
                        ...
                        { name: 'The Orthodox Case Against Predestination — And Why It Collapses', href: '/demolition-orthodox-predestination', desc: 'A thorough exegetical dismantling of the Eastern Orthodox argument against Reformed predestination — exposing the geneti' },
                        { name: 'The Strongest Case for Free Will — And Why Scripture Teaches Something Deeper', href: '/demolition-steel-man-arminianism', desc: 'We present the best theological arguments for free will — the strongest, most honest version of the case. Then we show w' }
                    ]
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'The Gratitude Test — Why Your Thank You Proves Sovereign Grace', href: '/philosophy-gratitude-test', desc: 'A logical argument that reveals the hidden theology of your heart: if your gratitude is 100% toward God, then your theol' },
                        ...
                        { name: 'You Didn\'t Choose to Be Born — The Argument from Childhood That Destroys Free Will', href: '/philosophy-children-argument', desc: 'The most intuitive proof of sovereign grace: you didn' },
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'Every Recovery Program Begins with Total Depravity', href: '/secular-recovery-total-depravity', desc: 'The 12 Steps accidentally confess the Reformed doctrine of total depravity. Millions in recovery have articulated the go' },
                        { name: 'Every Social Experiment Confirms What Scripture Already Knew', href: '/secular-sociology-human-inability', desc: 'Milgram. Stanford Prison. Mob psychology. Groupthink. Every experiment designed to test human nature discovers the same ' },
                        { name: 'Modern Psychology Keeps Proving Total Depravity', href: '/secular-psychology-bondage-of-will', desc: 'Cognitive bias, addiction research, and neuroscience all validate what the Reformers taught 500 years ago: the human wil' },
                        { name: 'Philosophy\'s 2,500-Year Verdict on Free Will — It Doesn\'t Exist', href: '/secular-philosophy-free-will', desc: 'Secular philosophy' },
                        ...
                        { name: 'The Billion Decisions Your Body Made Today Without Asking', href: '/secular-billion-decisions', desc: 'Your heart beat. Your cells divided. Your immune system fought. Your body made billions of sovereign decisions without a' },
            ...
            subcategories: [
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'The Cross-Examination — When Sovereign Grace Puts Free Will on the Witness Stand', href: '/story-cross-examination', desc: 'A gripping courtroom drama where the doctrine of free will faces cross-examination by Scripture itself. When answers col' },
            ...
            subcategories: [
                {
                    ...
                    pages: [
                        ...
                        { name: 'Open Theism: The Heresy That Finally Said the Quiet Part Out Loud', href: '/history-open-theism', desc: 'For 1,600 years the flesh has been smuggling in a God whose knowledge of the future depends on your choices. Open theism' },
                        ...
                        { name: 'The Canons of Dort — The Confession That Defended Grace Against Works', href: '/creed-canons-dort', desc: 'In 1619, the church formally declared that salvation is entirely God' },
                        ...
                        { name: 'The Great Awakening — When God\'s Sovereignty Set America on Fire', href: '/history-great-awakening', desc: 'Edwards preached. Whitefield thundered. And entire towns were converted overnight — not by clever marketing, but by sove' },
                        { name: 'The Heresy That Won\'t Die: 1,600 Years of the Foreknowledge Objection', href: '/history-heresy-foreknowledge', desc: 'The claim that God elects based on foreseen faith has been proposed, refuted, and resurrected for 1,600 years. Here is t' },
                        ...
                        { name: 'The Puritans — When Theology Set Nations on Fire', href: '/history-puritans', desc: 'John Owen. Jonathan Edwards. The Westminster Assembly. This was the golden age of Reformed theology — when devotional de' },
                        ...
                        { name: 'The Reformed Resurgence — How Sovereign Grace Came Back in the 20th Century', href: '/history-20th-century', desc: 'The liberal decline, the Reformed comeback, and sovereign grace rediscovered. Machen, Lloyd-Jones, Sproul, MacArthur. Yo' },
                        { name: 'The Synod of Dort — When the Church Formally Chose Grace Over Works', href: '/history-dort', desc: 'In 1619, the Arminian Remonstrants brought their case. 84 theologians from 8 countries examined it against Scripture — a' },
                        { name: 'The Synod of Dort: Five Points Forged in Fire', href: '/history-dort-deep', desc: 'For seven months in 1618-1619, the Reformed church put Arminianism on trial. Political intrigue, theological precision, ' },
                        { name: 'When Spurgeon Stood Alone for Truth — The Downgrade Controversy', href: '/history-spurgeon-downgrade', desc: 'The most beloved preacher in the world saw his own denomination abandoning biblical truth — and said so publicly. It cos' },
                        ...
                        { name: 'Written in Blood and Fire — The Dramatic Story Behind the Reformed Confessions', href: '/history-confessions-story', desc: 'The Heidelberg Catechism, Canons of Dort, Westminster Standards, 1689 Baptist Confession — behind every one is a story o' }
                    ]
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'John Calvin — The Theologian of God\'s Sovereignty', href: '/theologian-calvin', desc: 'The man who didn' },
                        ...
                        { name: 'Thomas Bradwardine — The Mathematician Who Proved God\'s Sovereignty', href: '/theologian-bradwardine', desc: 'A 14th-century mathematician defended divine sovereignty against the' }
                    ]
                }
            ]
        },
            ...
            subcategories: [
                {
                    ...
                    pages: [
                        ...
                        { name: 'He Loved You Before the World Was Made', href: '/devotional-love-before-the-world', desc: 'Before time. Before space. Before anything existed — God loved you. A meditation on the eternal, electing love that exis' },
                        ...
                        { name: 'You Were Chosen. Not Because You\'d Become Worthy.', href: '/devotional-glory-of-divine-choice', desc: 'You were chosen before the creation of the world. Not because you' },
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'The Christian Who Feels Like a Fraud — When Imposter Syndrome Meets Sovereignty', href: '/broken-mirror-imposter-syndrome', desc: 'You feel like you don' },
                        ...
                        { name: 'The Sin You Keep Repeating — And Why It Doesn\'t Disqualify You', href: '/broken-mirror-sin-you-repeat', desc: 'Trapped in a recurring sin and convinced you' },
                        ...
                        { name: 'When Your Family Can\'t Follow You — The Invisible Wall at the Dinner Table', href: '/invisible-wall-family', desc: 'God changed your theology and your family doesn' },
                        ...
                        { name: 'Why You Can Sleep When Everything Is Falling Apart', href: '/anxious-mind-sovereignty-of-sleep', desc: 'How God' },
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        { name: 'If God Already Chose, Why Share the Gospel?', href: '/pastoral-evangelism', desc: 'If God has already chosen who will be saved, why evangelize? Because Scripture teaches that your mouth is the very means' },
                        ...
                        { name: 'What It Feels Like When the Truth Lands', href: '/pastoral-when-truth-lands', desc: 'What it feels like when the truth of sovereign grace lands. A pastoral map for the vertigo, anger, grief, loneliness, te' },
                ...
                },
                {
                    ...
                    count: 7,
                    pages: [
                        { name: 'Joy in Suffering: Why Only Sovereign Grace Makes Pain Bearable', href: '/joy-in-suffering', desc: 'Discover why God' },
                        { name: 'The Freedom of Smallness', href: '/joy-freedom-of-smallness', desc: 'Discover the staggering relief of sovereign grace: you are not the hero of your salvation story. Being small is the most' },
                        ...
                        { name: 'The Joy No Other Theology Can Offer — Why Sovereign Grace Produces Unmatched Joy', href: '/joy-no-other-theology', desc: 'Reformed soteriology doesn' },
