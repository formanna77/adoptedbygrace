...
(function () {
 ...
 { name: 'The Golden Chain — Romans 8:29–30 Forged Before Your Eyes', href: '/golden-chain', desc: 'Five links. One unbroken chain. Scroll and watch Romans 8:29–30 forge itself in front of you — foreknown, predestined, c' },
 ...
 { name: 'Can You Lose Your Salvation? Once Saved, Always Saved Explained', href: '/question-perseverance', desc: 'They shall never perish. This is the Shepherd\'s promise. This is the Father\'s will. This is the Spirit\'s seal. Not be' },
 ...
 { name: 'No One Can Come to Me Unless the Father Draws Him', href: '/question-john6', desc: '"No one can come to me unless the Father who sent me draws them." Not "no one will." Not "no one finds it easy." Can. In' },
 ...
 { name: 'The Cost of Being Wrong', href: '/argument-cost-of-being-wrong', desc: '(A) Sovereign grace is true, and you believed it. (B) Sovereign grace is true, and you believed Arminianism. (C) Arminia' },
 ...
 { name: 'The Problem of Evil: Is God Unjust to Leave Some Unsaved?', href: '/objection-why-not-save-everyone', desc: 'Picture a long stone corridor. The lights are dim, the air smells faintly of bleach and old fear, and behind every door ' },
 ...
 { name: '"In Christ All Will Be Made Alive" — But Who Are the "All"?', href: '/demolition-1cor15-22', desc: 'Picture the moment. You were in a small group, or a comment thread, or a kitchen argument with a cousin who had just com' },
 ...
 { name: 'Jeremiah 18:1-12 — The Potter Demolished', href: '/demolition-jer18', desc: 'Read verses 7-10 carefully. The grammatical subject throughout is nations. "If at any time I announce that a nation or k' },
 ...
 { name: 'The Phantom Limb of Free Will', href: '/philosophy-phantom-limb-free-will', desc: 'Amputees feel their severed arms. You feel your free will. The sensation is real. The limb is gone. You cannot choose Go' },
 ...
 count: 39,
 pages: [
 { name: 'A Baby Doesn\'t Interview for a Family', href: '/analogy-adoption', desc: 'An orphan doesn\'t sign their own adoption papers. They don\'t evaluate the parents. They don\'t approve the transaction' },
 ...
 count: 2,
 pages: [
 { name: 'The Word "All" — A Lexical Study of Pas / Panta', href: '/word-study-every-all', desc: 'Notice the pattern. Every one of those verses rests on a single Greek word — pas , pantes , or panta , the word translat' },
 ...
 { name: 'The Invisible Wall — When Your Theology Costs You Relationships', href: '/invisible-wall-hub', desc: 'Three in five adults now report being lonely. The quiet epidemic nobody preaches about. But the sovereignty of God has s' },
